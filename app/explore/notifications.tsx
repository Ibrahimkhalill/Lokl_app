...
const NOTIFICATIONS = {
  new: [
    { id: 'n1', name: 'Katie Keller', action: 'reacted to your review of Book Club', time: '2d', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80' },
    { id: 'n2', name: 'Katie Keller', action: 'reacted to your review of Book Club', time: '2d', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80' },
  ],
  earlier: [
    { id: 'n3', name: 'Katie Keller', action: 'reacted to your review of Book Club', time: '2d', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&q=80' },
    { id: 'n4', name: 'Katie Keller', action: 'reacted to your review of Book Club', time: '2d', avatar: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=100&q=80' },
  ],
};

type NotifItem = { id: string; name: string; action: string; time: string; avatar: string };
