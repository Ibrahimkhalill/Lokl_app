...
const USER_POSTS = [
  {
    ...
    likes: 6, comments: 18, shares: '2K', saves: 35,
          ...
          <View key={post.id} style={styles.postCard}>
            ...
            {post.type === 'image' && (
              <View style={styles.postMeta}>
                ...
                <Text style={styles.postMetaText}>{(post as any).location}</Text>
...
const styles = StyleSheet.create({
  ...
  profileCard: {
    flexDirection: 'row', alignItems: 'center',
    gap: 16, paddingHorizontal: 16, marginBottom: 14,
  },
  avatar: {
    width: 72, height: 72, borderRadius: 36,
    borderWidth: 2.5, borderColor: '#7B61FF',
  },
  profileInfo: { flex: 1 },
  ...
  postCard: { borderTopWidth: 1, borderTopColor: Colors.cardBorder, paddingTop: 16 },
  postHeader: {
    flexDirection: 'row', alignItems: 'center',
    gap: 10, paddingHorizontal: 16, marginBottom: 8,
  },
  postAvatar: { width: 40, height: 40, borderRadius: 20, borderWidth: 2, borderColor: '#7B61FF' },
  ...
  postTag: { color: Colors.text, fontSize: 14, fontWeight: '600', paddingHorizontal: 16, marginBottom: 8 },
  postMeta: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 16, marginBottom: 10 },
  postMetaText: { color: Colors.textSecondary, fontSize: 13 },
  scoreBadge: { backgroundColor: Colors.primary, borderRadius: 6, paddingHorizontal: 7, paddingVertical: 2, marginLeft: 'auto' },
  scoreText: { color: Colors.black, fontSize: 12, fontWeight: '800' },
  postBody: { color: Colors.textSecondary, fontSize: 14, lineHeight: 22, paddingHorizontal: 16, marginBottom: 12 },
  postImageWrap: { marginHorizontal: 16, borderRadius: 16, overflow: 'hidden', position: 'relative', marginBottom: 12 },
  postImage: { width: '100%', height: 200 },
  playBtn: { position: 'absolute', top: '50%', left: '50%', width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center', marginLeft: -22, marginTop: -22 },
  distBadge: { position: 'absolute', top: 10, right: 10, flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(20,22,26,0.8)', borderRadius: 50, paddingVertical: 4, paddingHorizontal: 8 },
  distText: { color: Colors.text, fontSize: 11, fontWeight: '600' },
  postActions: { flexDirection: 'row', justifyContent:"space-between",  paddingHorizontal: 16, paddingBottom: 16, gap: 4 },
