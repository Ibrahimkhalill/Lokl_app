...
const REVIEWS = [
  {
    id: '1', name: 'Sarah, Mike', time: '2 days ago', rating: '9.2/10',
  ...
  {
    id: '2', name: 'Mike Rodriguez', time: '1 week ago', rating: '9/10',
        ...
        <View style={styles.content}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.actionsScroll}>
            <View style={styles.actionsRow}>
              ...
              <TouchableOpacity style={styles.actionBtn} onPress={() => router.push('/home/share-event')}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.friendRow}>
              <View style={styles.friendAvatars}>
                ...
                />
                <Image
                  source={{ uri: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&q=80' }}
...
const styles = StyleSheet.create({
  ...
  heroDot: { width: 8, height: 4, borderRadius: 2, backgroundColor: 'rgba(255,255,255,0.35)' },
  heroDotActive: { width: 22, backgroundColor: Colors.primary },
  content: { paddingHorizontal: 20, paddingTop: 20, paddingBottom: 40 },
  venueName: { color: Colors.text, fontSize: 22, fontWeight: '800', letterSpacing: 0.3, marginBottom: 8 },
  metaRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 16, flexWrap: 'wrap' },
  scoreChip: { backgroundColor: Colors.primary, borderRadius: 6, paddingHorizontal: 8, paddingVertical: 2 },
  ...
  friendsTitle: { color: Colors.primary, fontSize: 12, fontWeight: '700', letterSpacing: 0.5 },
  friendRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  friendAvatars: { flexDirection: 'row' },
  friendAvatar: { width: 32, height: 32, borderRadius: 16, borderWidth: 1.5, borderColor: Colors.background },
  ...
  sectionTitle: { color: Colors.text, fontSize: 14, fontWeight: '800', letterSpacing: 0.4, marginTop: 20, marginBottom: 12 },
  ...
  reviewText: { color: Colors.textSecondary, fontSize: 13, lineHeight: 20, marginBottom: 10 },
  reviewImages: {},
